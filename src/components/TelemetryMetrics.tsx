 ...
 */
export function TelemetryMetrics({ metrics }: Readonly<TelemetryMetricsProps>) {
  return (
    <Card
      data-testid="telemetry-metrics"
      className="border-0 shadow-none bg-transparent"
    >
      <CardContent data-testid="telemetry-metrics-content" className="p-0">
        ...
        <div className="mt-2 flex items-center justify-end gap-3 text-[10px] text-muted-foreground">
          <span>Loaded: {metrics.signalsLoaded}</span>
